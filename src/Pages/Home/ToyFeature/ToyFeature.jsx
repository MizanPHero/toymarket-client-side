        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="mb-10 text-center">
            <h1 className="mb-8 text-3xl font-semibold text-center text-red-600 text-centermx-auto sm:text-3xl title-font">
              What's make different our toys
            </h1>
            <p className="mx-auto text-base leading-relaxed xl:w-2/4 lg:w-3/4">
              Immerse yourself in a world of extraordinary craftsmanship, where
              every detail comes to life, setting our toys apart from the rest. 
            </p>
          </div>
            ...
            <div className="w-full p-2 sm:w-1/2">
              <div className="flex items-center h-full p-4 bg-gray-100 rounded">
                <svg
                  ...
                  strokeWidth="3"
                  className="flex-shrink-0 w-6 h-6 mr-4 text-red-500"
                  viewBox="0 0 24 24"
                >
