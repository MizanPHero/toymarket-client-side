...
const MyToyList = ({toy, handleDelete}) => {
  ...
  return (
    <tr className="border-b ">
      ...
      <td className="px-6 py-4 text-sm font-medium text-gray-900 whitespace-nowrap">
       <Link to={`../toy/${_id}`}><button className="px-4 py-2 font-bold text-white transition-colors duration-300 bg-blue-500 rounded shadow-md hover:bg-blue-600">Edit</button></Link>
      </td>
      <td className="px-6 py-4 text-sm font-medium text-gray-900 whitespace-nowrap">
